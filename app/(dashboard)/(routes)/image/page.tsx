...
const ImagePage = () => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      prompt: "",
      amount: amountOptions[0]?.value ?? "1",
      resolution: resolutionOptions[0]?.value ?? "512x512",
    },
  });
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      // clear only prompt; keep current selects
      form.reset({
        prompt: "",
              ...
              render={({ field }) => (
                <FormItem className="col-span-12 md:col-span-2">
                  ...
                  >
                    ...
                    {/* ✅ no position/sideOffset override; just high z-index */}
